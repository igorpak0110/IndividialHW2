...
public class PasswordEvaluationTestingAutomation {
	...
	public static void main(String[] args) {
		...
		//test case if all flags are passed but length is not long enough
		performTestCase(3, "1.Aa", false);
		
		//test case if length is enough but number, special character flags are not passed
		performTestCase(4, "Microsoft", false);
